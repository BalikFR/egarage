                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search12" class="input-text header-searchbar" placeholder="Search Clients name or Email" list="client">&nbsp;&nbsp;
...
?>
                    ...
                    <p class="heading-sub12" style="padding: 0;margin: 0;">
                        <?php 
                            ...
                            echo strftime('%e %B %Y'); // Affiche la date en français, par exemple "8 juin 2024"
                        ?>
                    </p>
                </td>
                    <td width="10%">
